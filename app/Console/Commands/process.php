...
class process extends Command
{
    ...
    public function handle(): void
    {
        ...
        $this->info('===============================================================');
        $this->info('Everything looks perfect! Now you can start use Sales Management System!');
        $this->info('If you have any question please contact with me by email: qaed.202x@gmail.com');
    }
}
