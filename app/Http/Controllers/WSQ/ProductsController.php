...
class ProductsController extends Controller
{
    ...
    public function processRenderCreateForm(): \Illuminate\View\View
    {
        ...
        return view('wsq.products.create');
    }
    ...
    public function processShowProductsDetails(Product $product): \Illuminate\View\View
    {
        ...
        return view('wsq.products.show')->with(['product' => $product]);
    }
    ...
    public function processRenderUpdateForm(Product $product): \Illuminate\View\View
    {
        ...
        return view('wsq.products.update')->with(['product' => $product, 'products' => ProductQueries::getAll()]);
    }
    ...
    public function processListOfProducts(): \Illuminate\View\View
    {
        ...
        return view('wsq.products.index')->with([
