...
class FinancesController extends Controller
{
    ...
    public function processRenderCreateForm()
    {
        ...
        return view('wsq.finances.create')->with(['companies' => CompanyQueries::getAll(true)]);
    }
    ...
    public function processShowFinancesDetails(Finance $finance)
    {
        ...
        return view('wsq.finances.show')->with(['finance' => $finance]);
    }
    ...
    public function processListOfFinances()
    {
        ...
        return view('wsq.finances.index')->with([
    ...
    public function processRenderUpdateForm(Finance $finance)
    {
        ...
        return view('wsq.finances.update')->with([
            'finance' => $finance,
