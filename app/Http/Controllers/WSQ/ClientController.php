...
namespace App\Http\Controllers\WSQ;
...
class ClientController extends Controller
{
    ...
    public function processRenderCreateForm(): \Illuminate\View\View
    {
        ...
        return view('wsq.clients.create');
    }
    ...
    public function processShowClientDetails(Client $client): \Illuminate\View\View
    {
        ...
        return view('wsq.clients.show')->with(['client' => $this->clientService->loadClientDetails($client)]);
    }
    ...
    public function processRenderUpdateForm(Client $client): \Illuminate\View\View
    {
        ...
        return view('wsq.clients.update')->with(['client' => $this->clientService->loadClientDetails($client)]);
    }
    ...
    public function processListOfClients(): \Illuminate\View\View
    {
        ...
        return view('wsq.clients.index')->with([
