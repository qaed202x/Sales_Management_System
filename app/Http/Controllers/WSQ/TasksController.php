...
class TasksController extends Controller
{
    ...
    public function processRenderCreateForm(): \Illuminate\View\View
    {
        ...
        return view('wsq.tasks.create')->with(['employees' => $this->employeesService->loadEmployees()]);
    }
    ...
    public function processListOfTasks(): \Illuminate\View\View
    {
        ...
        return view('wsq.tasks.index')->with(['tasks' => TaskQueries::getPaginate()]);
    }
    ...
    public function processShowTasksDetails(Task $task): \Illuminate\View\View
    {
        ...
        return view('wsq.tasks.show')->with(['task' => $task]);
    }
    ...
    public function processRenderUpdateForm(Task $task): \Illuminate\View\View
    {
        ...
        return view('wsq.tasks.update')->with([
            'task' => $task,
